...
#game options
MAINMENUOPTIONS = ['Quick Play', 'New Game', 'Load Game', 'Options', 'Exit Game']
...
#game flow
hudMenu = False
statDisplayMode = False
timeDisplayMode = False
goldDisplayMode = False
invDisplayMode = False
...
IMAGEDICT = {
    'World Map': pygame.image.load('images/map.jpg') ,
